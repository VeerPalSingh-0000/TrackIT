      ...
      >
        ...
        <div className="flex-shrink-0 p-6 sm:p-8 pb-4 sm:pb-6 relative border-b border-[var(--color-slate-700)]/50">
          ...
          <div className="flex items-center gap-3">
             ...
             <div>
                ...
                <p className="text-[var(--color-slate-400)] text-sm font-medium">Version 2.0</p>
             </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 space-y-6 text-[var(--color-slate-300)] leading-relaxed text-sm sm:text-base relative">
          ...
          <div className="pt-4 border-t border-[var(--color-slate-700)]/50 relative z-10">
            <h3 className="text-[var(--color-emerald-500)] font-bold mb-2">Our Core Philosophy</h3>
            <ul className="space-y-2 text-[var(--color-slate-400)]">
               <li className="flex gap-2 items-start"><span className="text-[var(--color-emerald-500)] mt-0.5">•</span> <span><strong>Simplicity first:</strong> No cluttered menus or unnecessary configurations.</span></li>
               <li className="flex gap-2 items-start"><span className="text-[var(--color-emerald-500)] mt-0.5">•</span> <span><strong>Data privacy:</strong> Your history is tied exclusively to your account.</span></li>
               <li className="flex gap-2 items-start"><span className="text-[var(--color-emerald-500)] mt-0.5">•</span> <span><strong>Aesthetic matters:</strong> An environment that looks professional makes you feel professional.</span></li>
            </ul>
          </div>
        </div>
      </motion.div>
