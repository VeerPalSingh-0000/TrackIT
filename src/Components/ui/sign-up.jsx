    ...
    >
      <defs>
        <linearGradient id="rev_grad1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop
            offset="0%"
            style={{ stopColor: "var(--color-emerald-500)", stopOpacity: 0.6 }}
          />
          <stop
            offset="100%"
            style={{ stopColor: "var(--color-emerald-400)", stopOpacity: 0.4 }}
          />
        </linearGradient>
        <linearGradient id="rev_grad2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop
            offset="0%"
            style={{ stopColor: "var(--color-emerald-600)", stopOpacity: 0.7 }}
          />
          <stop
            offset="50%"
            style={{ stopColor: "var(--color-emerald-500)", stopOpacity: 0.5 }}
          />
          <stop
            offset="100%"
            style={{ stopColor: "var(--color-emerald-600)", stopOpacity: 0.4 }}
          />
        </linearGradient>
        <radialGradient id="rev_grad3" cx="50%" cy="50%" r="50%">
          <stop
            offset="0%"
            style={{ stopColor: "var(--color-emerald-400)", stopOpacity: 0.7 }}
          />
          <stop
            offset="100%"
            style={{ stopColor: "var(--color-emerald-500)", stopOpacity: 0.3 }}
          />
        </radialGradient>
...
const DefaultLogo = () => (
  <div className="bg-[var(--color-emerald-500)] text-[var(--color-white)] rounded-md p-1.5">
    {" "}
...
export const AuthComponent = ({
  ...
  const handleFinalSubmit = async (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      try {
        ...
        setModalErrorMessage(
          err.message?.replace("Firebase: ", "") || "Sign up failed",
        );
        setModalStatus("error");
      }
    }
      ...
      {modalStatus !== "closed" && (
        ...
        >
          <motion.div
            ...
            className="relative bg-[var(--color-slate-900)] border-4 border-[var(--color-slate-700)] rounded-3xl p-8 w-full max-w-sm flex flex-col items-center gap-4 mx-2 shadow-2xl"
          >
            {modalStatus === "error" && (
              <button
                onClick={closeModal}
                className="absolute top-4 right-4 p-1 text-[var(--color-slate-400)] hover:text-[var(--color-white)] transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            )}
  ...
  const subtitleText = isLoginMode
    ? authStep === "email"
      ? "Sign in to continue your focus flow"
      : "Welcome back, " + email
    : authStep === "password"
  ...
  return (
    <div
      ...
      style={{ ...premiumDarkStyles, background: "var(--color-slate-950)" }}
    >
      <style>{`
      ...
      >
        {logo}
        <h1 className="text-base font-bold text-[var(--color-white)]">
          {brandName}
        </h1>
      </div>
      ...
      <div
        className={cn(
          "flex w-full flex-1 h-full items-center justify-center",
              ...
              >
                <BlurFade delay={0.25 * 1} className="w-full">
                  <div className="text-center">
                    <p className="font-serif font-light text-4xl sm:text-5xl md:text-6xl tracking-tight whitespace-nowrap text-[var(--color-white)]">
                      {titleText}
                    </p>
                  </div>
                </BlurFade>
                <BlurFade delay={0.25 * 2}>
                  <p className="text-sm font-bold opacity-80 text-[var(--color-slate-400)]">
                    {subtitleText}
                  </p>
                </BlurFade>
                ...
                <BlurFade delay={0.25 * 4} className="w-[300px]">
                  <div className="flex items-center w-full gap-2 py-2">
                    <hr className="w-full border-[var(--color-slate-700)]" />
                    <span className="text-xs font-bold opacity-60 text-[var(--color-slate-400)]">
                      OR
                    </span>
                    <hr className="w-full border-[var(--color-slate-700)]" />
                  </div>
            ...
            {authStep === "password" && !isLoginMode && (
              ...
              >
                <BlurFade delay={0} className="w-full">
                  <div className="text-center">
                    <p className="font-serif font-light text-4xl sm:text-5xl tracking-tight whitespace-nowrap text-[var(--color-white)]">
                      {titleText}
                    </p>
                  </div>
                </BlurFade>
                    ...
                    <div className="relative w-full">
                      <AnimatePresence>
                        {authStep === "password" && (
                          ...
                          >
                            <label className="text-xs font-semibold text-[var(--color-slate-400)]">
                              Email
                            </label>
                          </motion.div>
                        )}
                      ...
                      <div className="glass-input-wrap w-full">
                        <div className="glass-input">
                          ...
                          <div
                            className={cn(
                              "relative z-10 flex-shrink-0 flex items-center justify-center overflow-hidden transition-all duration-300 ease-in-out text-[var(--color-slate-300)]",
                          ...
                          <input
                            ...
                            className={cn(
                              "relative z-10 h-full w-0 flex-grow bg-transparent focus:outline-none transition-[padding-right] duration-300 ease-in-out delay-300 text-[var(--color-white)]",
                      ...
                      <BlurFade key="password-field" className="w-full">
                          ...
                          <div className="glass-input-wrap w-full">
                            <div className="glass-input">
                              ...
                              <div className="relative z-10 flex-shrink-0 flex items-center justify-center w-10 pl-2 text-[var(--color-slate-300)]">
                                {isPasswordValid ? (
                                  <button
                                    ...
                                    className="transition-colors p-2 rounded-full hover:bg-[var(--color-slate-700)]/50 text-[var(--color-emerald-400)]"
                                  >
                                    {showPassword ? (
                              ...
                              <input
                                ...
                                onKeyDown={handleKeyDown}
                                className="relative z-10 h-full w-0 flex-grow bg-transparent focus:outline-none text-[var(--color-white)]"
                              />
                              <div
                                className={cn(
                                  "relative z-10 flex-shrink-0 overflow-hidden transition-all duration-300 ease-in-out",
                        ...
                        <BlurFade inView delay={0.2}>
                          <button
                            ...
                            className="mt-4 flex items-center gap-2 text-sm transition-colors text-[var(--color-slate-400)] hover:text-[var(--color-white)]"
                          >
