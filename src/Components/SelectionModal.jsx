    ...
    <AnimatedModal onClose={onClose}>
      ...
      <div className="flex flex-col w-[90vw] h-[80vh] max-w-3xl bg-[var(--color-slate-950)]/80 backdrop-blur-3xl border border-white/[0.08] rounded-3xl shadow-2xl overflow-hidden motion-safe-gpu">
        ...
        <div className="p-6 border-b border-white/[0.05] flex justify-between items-center bg-white/[0.01]">
          <h2 className="text-[20px] font-semibold text-white tracking-tight">Select a Task</h2>
          <button 
            onClick={onClose} 
          ...
          {projects.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-[var(--color-slate-400)]">
                  <div className="w-16 h-16 mb-4 rounded-full bg-white/5 flex items-center justify-center">
                    <svg className="w-8 h-8 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
                  </div>
                  <p className="text-[15px] font-medium text-white mb-1">No projects found</p>
                  <p className="text-[13px] opacity-70">Click "New Project" in the menu to begin.</p>
              </div>
          )}
        </div>
      </div>
